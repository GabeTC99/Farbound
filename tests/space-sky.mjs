...
assert.equal(lights.window,true);
assert.equal(lights.nav,true);
assert.equal(stationLightPhase(1,false).bay,'lights_bay_flash');
assert.equal(stationLightPhase(.9,false).beacon,'lights_beacon_b');
assert.equal(stationLightPhase(.5,false).nav,false);
const lite=stationLightPhase(0,true);
assert.equal(lite.bay,null);
assert.equal(lite.beacon,null);
assert.equal(lite.nav,false);
assert.equal(lite.window,false);
