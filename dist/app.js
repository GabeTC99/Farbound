...
const frameClock=createFrameClock(),framePacer=createPacer(180),poseSnap={x:0,y:0,angle:0,ready:false};
...
function loop(now){
 ...
 if(document.hidden){engine.muteAll();resetFrameClock(frameClock);requestAnimationFrame(loop);return;}
