...
function handlePadEdges(edges){
 for(const edge of edges){
  ...
  if(edge==='cancel'){
   ...
   if(panel==='station'&&game.s.docked)closePanel();
   else if(panel==='help'||panel==='menu')closePanel();
   else closePanel();
   continue;
  }
