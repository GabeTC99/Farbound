...
function resize(){width=innerWidth;height=innerHeight;dpr=canvasDpr();canvas.width=Math.round(width*dpr);canvas.height=Math.round(height*dpr);if(panel==='map')drawMap();}window.addEventListener('resize',resize);
