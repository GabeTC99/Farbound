...
function drawRadar(){
 ...
 r.restore();
 r.fillStyle='#a7f0df';r.beginPath();r.moveTo(134,122);r.lineTo(128,142);r.lineTo(140,142);r.closePath();r.fill();
}
