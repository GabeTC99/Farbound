...
const DESK_META={
 market:{title:'Market counter',clerk:'Station trader',blurb:'Refuel and repair are the first two buttons. Then buy, sell, and watch the traffic board.'},
