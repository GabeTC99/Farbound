...
- **Ship:** Player-facing version stays **3.0.0**. Service worker cache is `farbound-v3.0.0-onfoot6` so Pages testers pick up the JS and planetary MP3s. Android `versionCode` stays **13**. Do **not** tag Android or Windows Releases.
