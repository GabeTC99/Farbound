...
- **Ship audio:** generated sci-fi engine and afterburner loops (Scenario / ElevenLabs Sound Effects) layered with a live airy whoosh and pad that follow speed and boost. They pause in menus and in the background, and have their own volume slider next to the sound toggle. Lasers, interface blips, confirmations and hyperspace jumps use generated samples in `dist/audio/`.
- **Station art:** orbital stations draw a solid generated sprite (`dist/station.webp`) rather than outline rings.
