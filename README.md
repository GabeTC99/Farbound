...
- **Ship:** Player-facing version stays **3.0.0**. Service worker cache is `farbound-v3.0.0-ships4` so Pages testers pick up all 20 hull plates plus the 21 thruster, flyby, and land MP3s already shipped. Android `versionCode` stays **13**. Do **not** tag Android or Windows Releases.
