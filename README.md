...
- **Scenario Pro art:** `dist/assets/new-frontier/` ships Gabe-approved plates (commercial cleared by Risk). `planet-surface-a/b` tile landing / pad ground. `landing-a/b` crop as far-field vistas — title HUD is not drawn over play. Full / Balanced draw plates; Performance keeps tiled ground at 192 px and skips the vista.
